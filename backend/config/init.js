...
async function initDB(pool) {
  ...
  try {
    ...
    await runQuery("RestaurantOrderDetailCur - SongName", "IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[RestaurantOrderDetailCur]') AND name = 'SongName') ALTER TABLE [dbo].[RestaurantOrderDetailCur] ADD SongName NVARCHAR(255) NULL");
    await runQuery("RestaurantOrderDetail - SongName", "IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[RestaurantOrderDetail]') AND name = 'SongName') ALTER TABLE [dbo].[RestaurantOrderDetail] ADD SongName NVARCHAR(255) NULL");
    await runQuery("DishMaster - IsSplitDish", "IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[DishMaster]') AND name = 'IsSplitDish') ALTER TABLE [dbo].[DishMaster] ADD IsSplitDish BIT NOT NULL DEFAULT 0");
    await runQuery("DishMaster - IsGroupDish", "IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[DishMaster]') AND name = 'IsGroupDish') ALTER TABLE [dbo].[DishMaster] ADD IsGroupDish BIT NOT NULL DEFAULT 0");
    await runQuery("DishMaster - songName", "IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[dbo].[DishMaster]') AND name = 'songName') ALTER TABLE [dbo].[DishMaster] ADD songName NVARCHAR(255) NULL");
